...
def run_analysis_pipeline(ticker: str) -> dict:
    """
    ...
    hist_data = get_historical_data(ticker, period="1y")
    ...
    manager_report = generate_portfolio_decision(ticker, tech_report, fund_report)
